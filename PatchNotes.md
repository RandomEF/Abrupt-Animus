...
- Fixed bug with menu changing and KeyNotFoundExceptions and NullReferenceExceptions
- Added a subtitle to the screen
- Changed camera to use the built-in static reference
- Added zoom
- Fixed bug with menus and the cursor remaining locked
- Lots of comments
- Formatting with dotnet formatter
