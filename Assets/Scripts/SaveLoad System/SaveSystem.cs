...
public static class SaveSystem
{
    ...
    public static SaveData NewSave(){
        ...
        if (!Directory.Exists(Path.Combine(Application.persistentDataPath, "Saves", folderName))){
            ...
            throw new Exception("The save folder was unable to be created.");
        }
        ...
        // Modify the lookup
        using (StreamWriter saveLookup = File.AppendText(Path.Combine(Application.persistentDataPath, "SaveLookup.txt"))){
